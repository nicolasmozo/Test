<?php
 return array (
  ...
  'Commission percentage is required' => 'Commission percentage is required',
  'Payout type is required' => 'Payout type is required',
  'Invalid payout type' => 'Invalid payout type',
  'Commission percentage is required when payout type is commission-based' => 'Commission percentage is required when payout type is commission-based',
  'Commission percentage must be a number' => 'Commission percentage must be a number',
  'Commission percentage must be at least 0' => 'Commission percentage must be at least 0',
  'Plan type is required' => 'Plan type is required',
  'Plan price is required' => 'Plan price is required',
  'Plan price should be numeric value' => 'Plan price should be numeric value',
  ...
  'Serial must be unique' => 'Serial must be unique',
);
 ?>