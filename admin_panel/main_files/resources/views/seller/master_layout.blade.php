    ...
    <div class="main-wrapper">
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              ...
              <a href="{{ route('seller.edit-profile') }}" class="dropdown-item has-icon">
                <i class="far fa-user"></i> {{__('admin.Profile')}}
              </a>
              <div class="dropdown-divider"></div>
              <a href="{{ route('seller.logout') }}" class="dropdown-item has-icon text-danger" onclick="event.preventDefault();
              document.getElementById('admin-logout-form').submit();">
                <i class="fas fa-sign-out-alt"></i> {{__('admin.Logout')}}
              </a>
            {{-- start admin logout form --}}
            <form id="admin-logout-form" action="{{ route('seller.logout') }}" method="POST" class="d-none">
                @csrf
            </form>
      ...
      <footer class="main-footer">
        ...
        <div class="footer-right">
            {{ __('admin.Current Version') }} : {{ $setting->app_version }}
          </div>
      </footer>
    </div>
  </div>
