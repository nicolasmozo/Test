                ...
                <div class="card">
                  <div class="card-body">
                    <ul class="nav nav-pills flex-column">
                      <li class="nav-item"><a href="{{ route('seller.product.edit',['product' => $product->id, 'lang_code' => 'en']) }}" class="nav-link">{{__('admin.Basic Information')}}</a></li>

                      <li class="nav-item"><a href="{{ route('seller.product-variant', $product->id) }}" class="nav-link active">{{__('admin.Variants of Service')}}</a></li>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <form action="{{ route('seller.store-product-variant', $product->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
    ...
    <div class="modal fade" id="editVariant-{{ $product_variant->id }}" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <form action="{{ route('seller.update-product-variant', $product_variant->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
