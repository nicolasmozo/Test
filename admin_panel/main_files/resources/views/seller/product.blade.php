                        ...
                        <table class="table table-striped" id="dataTable">
                            ...
                            <tbody>
                                @foreach ($products as $index => $product)
                                    <tr>
                                        <td>{{ ++$index }}</td>
                                        <td><a href="{{ route('seller.product.edit',['product' => $product->id, 'lang_code' => 'en']) }}">{{ html_decode($product->productlangadmin->name) }}</a></td>
                                        @php
                                        ...
                                        <td>
                                        <a href="{{ route('seller.product.edit',['product' => $product->id, 'lang_code' => 'en']) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit" aria-hidden="true"></i></a>
                                        @php
