              ...
              <div class="card">
                <div class="card-header">
                  ...
                  <div class="card-header-action">
                    <div class="btn-group">
                      <a href="javascript:;" id="weeklyReport" class="btn btn-primary">{{ __('admin.Week') }}</a>
                      <a href="javascript:;" id="monthlyReport" class="btn">{{ __('admin.Month') }}</a>
                    </div>
                  </div>
                </div>
                <div class="card-body">
            ...
            <div class="col-lg-4 col-md-12 col-12 col-sm-12">
                <div class="card">
                    <div class="card-header">
                      ...
                      <div class="card-header-action">
                        <a href="{{ route('admin.all-booking') }}" class="btn btn-danger">{{ __('admin.View More') }} <i class="fas fa-chevron-right"></i></a>
                      </div>
                    </div>
                                ...
                                @foreach ($order_items as $index => $order_item)
                                    <tr>
                                        ...
                                        <td>
                                          ...
                                          <a href="{{ route('admin.order-show',$order_item->order_id) }}" class="btn btn-primary btn-sm"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
                                  @endforeach
                            </tbody>
