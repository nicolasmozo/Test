                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.withdraw-method.update',$method->id) }}" method="POST" >
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-12">
                                    <label>{{__('admin.Minimum Amount')}} <span class="text-danger">* ({{__('admin.USD Amount')}})</span></label>
                                    <input type="text" id="minimum_amount" class="form-control"  name="minimum_amount" value="{{ $method->min_amount }}">
                                </div>

                                <div class="form-group col-12">
                                    <label>{{__('admin.Maximum Amount')}} <span class="text-danger">* ({{__('admin.USD Amount')}})</span></label>
